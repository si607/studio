    ...
    try {
      const {media} = await ai.generate({
        ...
        prompt: [
          ...
          {text: "You are an AI photo restoration expert. Your single, most important task is to meticulously remove all physical damages (scratches, creases, tears, spots) while **strictly preserving the original subject's identity and facial structure.**\n\nFollow these critical instructions:\n1.  **Seamless Repair:** Intelligently reconstruct damaged areas by analyzing surrounding pixels to make the repair invisible. Preserve original details, textures, and film grain.\n2.  **Avoid Blurriness:** The final output must look like a pristine, undamaged original, avoiding any blurry or artificially smooth patches.\n3.  **Identity is Paramount:** If a face is present, do not alter its bone structure, jawline, or any unique characteristics.\n4.  **No Watermarks:** Do not add any watermark or text to the image."},
        ],
        config: {
