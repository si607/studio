    ...
    try {
      const {media} = await ai.generate({
        ...
        prompt: [
          ...
          {text: "You are an AI photo sharpening expert. Your single, most important task is to apply intelligent, professional-grade sharpening while **strictly preserving the original subject's identity and facial structure.**\n\nFollow these critical instructions:\n1.  **Selective Sharpening:** Analyze the image and selectively enhance key subjects and textures (e.g., edges, eyes). Avoid sharpening noise, film grain, or out-of-focus backgrounds.\n2.  **Natural Result:** The goal is a crisper, more defined image that looks naturally sharp, without digital artifacts, halos, or an over-sharpened look.\n3.  **Identity is Paramount:** If a face is present, enhance its clarity but do not alter its bone structure, jawline, or any unique characteristics.\n4.  **No Watermarks:** Do not add any watermark or text to the image."},
        ],
        config: {
