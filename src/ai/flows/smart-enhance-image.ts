    ...
    try {
      const {media} = await ai.generate({
        ...
        prompt: [
          ...
          {text: "Perform a professional-grade enhancement on the provided image. Significantly upscale the resolution (aiming for at least 4x if feasible) while maximizing photorealistic detail, texture, and sharpness. Aggressively reduce noise and artifacts without sacrificing fine details or creating an unnatural, 'plastic' look. For any human faces present, bring out natural fine details, improve skin texture to be clear yet realistic (avoid over-smoothing), and enhance eye clarity for a striking, yet authentic result. The output should be a remarkably improved, high-definition version of the original, respecting its core composition and artistic intent. Ensure all enhancements are harmonious and contribute to a polished, professional final image. Also, discreetly incorporate a very small, semi-transparent \"PicShine AI\" watermark in one of the bottom corners of the image. Ensure it is unobtrusive and occupies minimal space."},
        ],
        config: {
