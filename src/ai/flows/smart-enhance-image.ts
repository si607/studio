    ...
    try {
      const {media} = await ai.generate({
        ...
        prompt: [
          ...
          {text: "Perform a significant upscaling of the provided image, aiming for at least a 4x resolution increase while ensuring maximum photorealistic detail and sharpness. Aggressively reduce noise and artifacts, but avoid creating an unnatural, 'plastic' look. If human faces are present, enhance them with natural fine details, improve skin texture to be clear but realistic (no over-smoothing), and enhance eye clarity. The final output should be a remarkably improved, high-definition version of the original that respects its original composition. Ensure all enhancements are harmonious and contribute to a polished, professional final image. Also, discreetly incorporate a very small, semi-transparent \"PicShine AI\" watermark in one of the bottom corners of the image. Ensure it is unobtrusive and occupies minimal space."},
        ],
        config: {
